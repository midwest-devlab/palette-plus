import {
  Logo
} from "./chunk-JGJB3PIH.js";

// src/components/palette-plus/Provider.tsx
import { createContext, useContext, useEffect, useMemo, useState } from "react";
import { jsx } from "react/jsx-runtime";
var PalettePlusCtx = createContext(null);
...
function PalettePlusProvider({
  ...
  return /* @__PURE__ */ jsx(PalettePlusCtx.Provider, { value, children });
}
      ...
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2 border-b px-3 py-2", children: [
            ...
            /* @__PURE__ */ jsx2("h2", { className: "text-sm font-semibold", children: title }),
            /* @__PURE__ */ jsxs("p", { className: "mt-1 text-sm text-neutral-400", children: [
              "Click to copy. Hold ",
              /* @__PURE__ */ jsx2("kbd", { className: "px-1 rounded bg-neutral-800", children: "Shift" }),
              " for",
              /* @__PURE__ */ jsx2("span", { className: "font-mono", children: " bg-*" }),
              ", ",
              /* @__PURE__ */ jsx2("kbd", { className: "px-1 rounded bg-neutral-800", children: "Ctrl/\u2318" }),
              " for",
              /* @__PURE__ */ jsx2("span", { className: "font-mono", children: " text-*" }),
              ", ",
              /* @__PURE__ */ jsx2("kbd", { className: "px-1 rounded bg-neutral-800", children: "Alt" }),
              " for",
              /* @__PURE__ */ jsx2("span", { className: "font-mono", children: " hue-shade" }),
              "."
            ] }),
            /* @__PURE__ */ jsx2(
              "button",
          ...
          /* @__PURE__ */ jsxs("div", { className: "fixed grid grid-cols-11 gap-8.25 text-xs text-neutral-400 text-center pl-29 pr-13 py-4 bg-neutral-950 z-20", children: [
            /* @__PURE__ */ jsx2("p", { children: "50" }),
            /* @__PURE__ */ jsx2("p", { children: "100" }),
            /* @__PURE__ */ jsx2("p", { children: "200" }),
            /* @__PURE__ */ jsx2("p", { children: "300" }),
            /* @__PURE__ */ jsx2("p", { children: "400" }),
            /* @__PURE__ */ jsx2("p", { children: "500" }),
            /* @__PURE__ */ jsx2("p", { children: "600" }),
            /* @__PURE__ */ jsx2("p", { children: "700" }),
            /* @__PURE__ */ jsx2("p", { children: "800" }),
            /* @__PURE__ */ jsx2("p", { children: "900" }),
            /* @__PURE__ */ jsx2("p", { children: "950" })
          ] }),
          /* @__PURE__ */ jsx2("div", { className: "h-[calc(100dvh-40px)] overflow-auto p-3", children })
        ]
      }
    )
  ] });
...
function PaletteToggleButton() {
  ...
  return /* @__PURE__ */ jsx4(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx4("span", { className: "text-2xl drop-shadow-lg drop-shadow-black/100", children: "\u{1F3A8}" })
    }
  );
}

// src/components/Palette.tsx
import React3, { useMemo as useMemo2, useRef, useState as useState2 } from "react";
...
function Toast({ value }) {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "fixed bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-neutral-900/90 px-4 py-2 text-sm text-white shadow-lg backdrop-blur-sm z-50", children: [
    "Copied ",
    /* @__PURE__ */ jsx5("span", { className: "font-mono", children: value })
  ] });
}
function Tooltip({ text, x, y, show }) {
  ...
  return /* @__PURE__ */ jsx5(
    "div",
    {
      ...
      style: { left: x, top: y },
      children: /* @__PURE__ */ jsx5("span", { className: "font-mono", children: text })
    }
  );
}
function Swatch({ cls, label, hue, shade }) {
  return /* @__PURE__ */ jsxs2(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx5("span", { className: "pointer-events-none absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity ring-1 ring-black/10" }),
        /* @__PURE__ */ jsx5("span", { className: "sr-only", children: label })
      ]
    }
  );
}
function Palette() {
  ...
  const [toastValue, setToastValue] = useState2(null);
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "min-h-dvh text-neutral-200 antialiased", children: [
    /* @__PURE__ */ jsxs2("div", { className: "mx-auto max-w-[1200px] px-6", children: [
      /* @__PURE__ */ jsx5("header", { className: "mb-2 flex flex-col justify-between", children: /* @__PURE__ */ jsx5("div", { className: "hidden md:flex items-center gap-[5px] ml-17 mt-4 text-xs text-neutral-400", children: SHADES.map((s) => /* @__PURE__ */ jsx5("div", { className: "grid w-12 justify-items-center", children: s }, s)) }) }),
      /* @__PURE__ */ jsx5("div", { className: "grid grid-cols-[auto_1fr] gap-x-4 gap-y-2", children: rows.map((cells, rowIdx) => /* @__PURE__ */ jsxs2(React3.Fragment, { children: [
        /* @__PURE__ */ jsx5("div", { className: "sticky left-0 z-10 text-sm text-neutral-300 content-center justify-self-end", children: HUES[rowIdx][0].toUpperCase() + HUES[rowIdx].slice(1) }),
        /* @__PURE__ */ jsx5(
          "div",
          {
            ref: gridRef,
            ...
            children: cells.map(({ cls, id, hue, shade }) => /* @__PURE__ */ jsx5(
              Swatch,
              {
                cls,
                label: `${hue} ${shade}`,
    ...
    /* @__PURE__ */ jsx5(Tooltip, { text: tip.text, x: tip.x, y: tip.y, show: tip.show }),
    /* @__PURE__ */ jsx5(Toast, { value: toastValue })
  ] });
}
export {
  Logo,
